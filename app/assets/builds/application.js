...
%o`, message, error2, detail);
  ...
  // app/javascript/controllers/testing_controller.js
  var testing_controller_default = class extends Controller {
    connect() {
    }
  };
  ...
  application.register("testing", testing_controller_default);
